...
namespace Khalidmaquilang\SensorsPlus\Commands;

use Native\Mobile\Plugins\Commands\NativePluginHookCommand;

/**
 * Copy assets hook command for SensorsPlus plugin.
 *
...
{
    protected $signature = 'nativephp:sensors-plus:copy-assets';

    protected $description = 'Copy assets for SensorsPlus plugin';
    ...
    protected function copyAndroidAssets(): void
    {
        ...
        $this->info('Android assets copied for SensorsPlus');
    }
    ...
    protected function copyIosAssets(): void
    {
        ...
        $this->info('iOS assets copied for SensorsPlus');
    }
}